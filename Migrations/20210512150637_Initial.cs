    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserSeenFilms", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserSeenFilms_Films_FilmId",
                        column: x => x.FilmId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<int>(type: "int", nullable: false),
                    UserSeenFilmId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Ratings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Ratings_UserSeenFilms_UserSeenFilmId",
                        column: x => x.UserSeenFilmId,
                        principalTable: "UserSeenFilms",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
